...
- `pages/posts/[id].js` [看起來應該要長這樣](https://github.com/vercel/next-learn/blob/master/basics/dynamic-routes-step-1/pages/posts/%5Bid%5D.js)
- `lib/posts.js` [看起來應該要長這樣](https://github.com/vercel/next-learn/blob/master/basics/dynamic-routes-step-1/lib/posts.js)
- （還是有錯誤的話）剩下的程式碼[應該要長這樣](https://github.com/vercel/next-learn/tree/master/basics/dynamic-routes-step-1)。
