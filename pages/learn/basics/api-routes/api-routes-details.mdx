...
你**不**應該從 <a href="/docs/basic-features/data-fetching/overview#getstaticprops-static-generation" class="link-code" target="_blank">`getStaticProps`</a> 或 <a href="/docs/basic-features/data-fetching/overview#getstaticpaths-static-generation" class="link-code" target="_blank">`getStaticPaths`</a> 中提取 API 路由。相反地，你應該直接在 <a href="/docs/basic-features/data-fetching/overview#getstaticprops-static-generation" class="link-code" target="_blank">`getStaticProps`</a> 或 <a href="/docs/basic-features/data-fetching/overview#getstaticpaths-static-generation" class="link-code" target="_blank">`getStaticPaths`</a> 中撰寫你的伺服器端程式碼（或呼叫輔助函式）。

原因：<a href="/docs/basic-features/data-fetching/overview#getstaticprops-static-generation" class="link-code" target="_blank">`getStaticProps`</a> 和 <a href="/docs/basic-features/data-fetching/overview#getstaticpaths-static-generation" class="link-code" target="_blank">`getStaticPaths`</a> 只會在伺服器端執行，並且永遠不會在客戶端執行。此外，這些函式不會包含在瀏覽器的 JS bundle 中。這意味著你可以撰寫直接查詢資料庫的程式碼，而不會將其傳送給客戶端。參閲<a href="/docs/basic-features/data-fetching/get-static-props#write-server-side-code-directly" target="_blank">撰寫伺服器端程式碼</a>文件以瞭解更多資訊。
