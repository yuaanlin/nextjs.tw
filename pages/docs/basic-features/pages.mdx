...
<details open>
  ...
  <ul>
    ...
    <li>
      <a href="https://github.com/vercel/next.js/tree/canary/examples/cms-builder-io">
        Builder.io Example
      </a>{" "}
      (<a href="https://cms-builder-io.vercel.app/">Demo</a>)
    </li>
    <li>
      <a href="https://github.com/vercel/next.js/tree/canary/examples/cms-tina">
        TinaCMS Example
      </a>{" "}
      (<a href="https://cms-tina-example.vercel.app/">Demo</a>)
    </li>
    <li>
