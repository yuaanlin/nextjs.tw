...
Next.js 允許你從 JavaScript 輸入(`import`) CSS 檔案，主要是因為 Next.js 擴充了 JavaScript [輸入 `import`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Statements/import) 概念。
