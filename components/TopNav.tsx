        ...
        >
          ...
          <div className="flex">
            <div className="flex flex-row items-center justify-center space-x-8">
              ...
              >
                <NavbarItem href="/docs/getting-started" path="docs">
                  官方文件
                </NavbarItem>
                <NavbarItem href="/examples" path="examples">
                  使用案例
                </NavbarItem>
                <a
                  href="https://nextjs.org"
                  className="flex py-[10px] px-[8px] md:inline-flex md:py-0 md:px-0 opacity-50 transition-opacity hover:opacity-100"
                >
                  英文官網
                </a>
              </div>
